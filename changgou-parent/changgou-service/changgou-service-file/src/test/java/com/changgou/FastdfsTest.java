...
public class FastdfsTest {
    ...
    public void upload() throws Exception{
        ...
        //2.加载配置文件生效
        ClientGlobal.init("E:\\黑马学习视频\\深圳黑马\\就业班\\day86changgou-day15\\代码\\changgou104\\changgou-parent\\changgou-service\\changgou-service-file\\src\\main\\resources\\fdfs_client.conf");
        //3.创建trackerclient对象
        ...
        String[] pngs = storageClient.upload_file("C:\\Users\\Alvin\\Pictures\\1608429746450.png", "png", null);
        for (String png : pngs) {
    ...
    public void download() throws Exception{
        ...
        byte[] bytes = storageClient.download_file("group1", "M00/00/00/wKjThGDx0lGAZmsPAAGgVTWvg1g591.png");
